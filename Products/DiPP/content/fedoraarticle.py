...
class FedoraArticle(BrowserDefaultMixin, OrderedBaseFolder):
    ...
    manage_options = OrderedBaseFolder.manage_options[0:1] + (
        {'label': 'View', 'action': ''},
        {'label': 'Fedora', 'action': 'manage_fedora_form', 'help': ('DiPP', 'fedora.stx')},
    ...
    def update_toc(self):
        ...
        if self.hasProperty('deepest_toc_level'):
            deepest_toc_level = self.deepest_toc_level
        else:
