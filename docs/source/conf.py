# -*- coding: utf-8 -*-
#
# DiPP documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../Products/DiPP'))
sys.path.insert(0, os.path.abspath('/home/reimer/Plone/zinstance/parts/omelette/'))
...
man_pages = [
    ('index', 'dipp', u'DiPP Documentation',
     [u'Peter Reimer'], 1)
]
